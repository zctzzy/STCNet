...
parse.add_argument('-epoch_size', type=int, default=400, help='epochs')
...
def predict(test_type='train'):
    ...
    # model.load_state_dict(torch.load('/home/dl/ct/SavedModel/OneCluster/call/model=densenetlr=0.01-close=3-period=0-meta=0-cross=1-crop=True-cluster=1.0' + '.pt'))
...
if __name__ == '__main__':
    ...
    # prediction_ct[-24] = ((truth_ct[-25] + truth_ct[-26] + truth_ct[-27]) / 3.0)
